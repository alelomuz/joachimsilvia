...
const translations = {
    en: {
        ...
        description5n2: "Wednesday, September 17: Matera and dinner at the brasserie (with vegetarian option).",
        description5n3: "Thursday, September 18: Taranto and fish dinner (with vegetarian option).",
        description5n4: "Friday, September 19: Amaro Lucano museum and dinner at Porto degli Argonauti (with vegetarian option).",
    ...
    de: {
        ...
        description5n4: "Freitag der 19. September: Museum Amaro Lucano und Abendessen bei Porto degli Argonauti  (mit vegetarische Option).",
    ...
    it: {
        ...
        description5n4: "Venerdí 19 Settembre: Museo dell'Amaro Lucano e cena presso Porto degli Argonauti (con opzione vegetariana).",
        description5n5: "Alternative vegane su richiesta.",
